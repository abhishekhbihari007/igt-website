...
const ProgramRouter: React.FC = () => {
  ...
  const programComponents: { [key: string]: React.ComponentType } = {
    ...
    'master-program-in-ai-data-analytics': DataScienceProgram,
    ...
    // Consolidated mappings - removing duplicates
    ...
    // Removed duplicate AR/VR mapping
    ...
    // Removed duplicate Mixed Reality and XR Gaming mappings
